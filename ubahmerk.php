...
$id = $_GET['id'];
$query = "SELECT * FROM tb_eyelashtreatment WHERE id=" . $id;
...
<body>
    <div class="alert alert-success text-center" role="alert">
        <h2>eyelash treatment dini</h2>
    </div>
    <h1 class="ml-5">Ubah Merk  </h1>
    ...
    <form method="post" action="prosesubah.php" class="ml-5">
        <?php while ($data = mysqli_fetch_array($hasil)) { ?>
            ...
            <div class=" form-group row">
                ...
                <div class="col-sm-3">
                    <input type="text" name="merk" class="form-control" value="<?php echo $data['treatment'] ?>">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <label for="warna" class="col-sm-1 col-formlabel">type</label>
                <div class="col-sm-3">
                    <input type="text" name="warna" class="formcontrol" value="<?php echo $data['merk'] ?>">
                </div>
            </div>
            <div class="form-group row">
...
mr-0">Kirim</button>
            <a href="index.php" class="btn btn-primary mb-1 mt-1 ml0"><i class="fas fa-user-plus mr-0"></i>eyelash treatment dini</a>
    </form>
<?php } ?>
<!-- Optional JavaScript -->
