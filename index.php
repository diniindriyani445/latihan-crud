...
<head>
    <title>eyelash treatment dini</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <a href="tambahmerk.php" class="btn btn-primary
mb-1 mt-1"><i class="fas fa-user-plus mr2"></i>Tambah eyelash</a>
            ...
            <?php while ($data = mysqli_fetch_array($hasil)) { ?>
                <tr>
                   ...
                   <td> <?php echo $data['harga']; ?> </td>
                    ...
                    $data['id'] ?>">Edit</a> | <a href="hapusmerk.php?id=<?php echo
                     $data['id'] ?>">Delete</a></td>
